...
`cloud-itonami-iso3166-nzl` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
New Zealand-licensed counsel or a registered agent for whatever licensed
representation the law of New Zealand requires for public-procurement
filings.
