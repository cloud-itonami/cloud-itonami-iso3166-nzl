# cloud-itonami-iso3166-nzl

Open ISO 3166 Blueprint for **NZL**: New Zealand.
...
tax registration, and local-content rules in New Zealand, so the operator
...
- **Not the government of New Zealand.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to New Zealand-licensed counsel
...
(ISO 3166 `NZL`). Required capabilities:
